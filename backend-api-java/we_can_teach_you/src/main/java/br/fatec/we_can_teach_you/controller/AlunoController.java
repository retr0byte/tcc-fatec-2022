...
import br.fatec.we_can_teach_you.service.AlunoService;

@RestController
@RequestMapping("/alunos")
public class AlunoController implements ControllerInterface<AlunoDTO> {
    ...
    @Override
    @PostMapping
    public ResponseEntity<AlunoDTO> post(@RequestBody AlunoDTO obj) throws URISyntaxException {
        AlunoDTO dto = service.create(obj);
