...
import br.fatec.we_can_teach_you.service.EventoService;

@RestController
@RequestMapping("/eventos")
public class EventoController implements ControllerInterface<EventoDTO>{
    @Autowired
    ...
    @PutMapping
    @PreAuthorize("hasAnyRole('ADMIN')")
    public ResponseEntity<?> put(@RequestBody EventoDTO obj) {
